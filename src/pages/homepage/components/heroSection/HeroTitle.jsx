...
const HeroTitle = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center z-0">
      <h1 className="mx-auto max-w-3xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative z-0">Digital Auctions</span>
          </span>
        </span>
      ...
      <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        Bring the best digital auction experience to your online marketplace.
      </p>
